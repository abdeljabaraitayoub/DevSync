...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    <form class="max-w-sm w-full bg-white p-6 rounded-lg shadow-md" action="/login" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="hidden" id="email" name="_method" value="post" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="name@flowbite.com" />
