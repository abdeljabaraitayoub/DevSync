        ...
        <form action="/tasks" id="form-task" method="POST" class="space-y-5">
            ...
            <div class="flex space-x-4">
                ...
                <div class="w-1/2">
                    ...
                    <select id="userId2" name="user_id"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="flex space-x-4">
                ...
                <div class="w-1/2">
                    ...
                    <select multiple id="tags" name="tags[]"
                            class=" js-example-basic-multiple shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
